...
export default function TwitchCategoriesLoading() {
  return (
      ...
      <section className={PAGE_SECTION_CLASS}>
        ...
        <div className={CARD_GRID_CLASS}>
          {Array.from({ length: 24 }).map((_, index) => (
            <Card
              key={index}
              className="overflow-hidden rounded-2xl border-zinc-200 bg-white/90 shadow-sm dark:border-zinc-800 dark:bg-zinc-900/85"
            >
